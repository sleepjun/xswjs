...
public class NewsAction extends ActionSupport{
		...
		Document doc;
		 String s = "";
			try {
		        ...
		        //http://www.hzqbyp.com
		        s = s.replaceAll("http://www.hzqbyp.comhttp://www.hzqbyp.com/uploadfile", "http://www.hzqbyp.com/uploadfile");
		        s = s.replaceAll("/uploadfile/file", "http://www.hzqbyp.com/uploadfile/file");
			   // System.out.println(s);    	      		      		        
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
	...
	public String getinform(int i)
	{
		Document doc;
		 String s = "";
			try {
				doc = Jsoup.connect("http://www.hzqbyp.com/list.asp?id="+i).get();
				//System.out.println(doc);
		        Elements content = doc.getElementsByClass("neirong");
		        s = content.outerHtml();
		        s = s.replaceAll("/uploadfile/image/", "http://www.hzqbyp.com/uploadfile/image/");
	...
	public String itz(){ return getinform(2);};
	public String isg(){ return getinform(3);};
	public String itg(){ return getinform(4);};
	public String ijy(){ return getinform(5);};
	public String ixh(){ return getinform(6);};
	public String ijypz(){ return getinform(7);};
	public String khlc()
	{
		Document doc;
		 String s = "";
			try {
				doc = Jsoup.connect("http://www.hzqbyp.com/about.asp?id=14").get();
				System.out.println(doc);
		        Elements content = doc.getElementsByClass("neirong");
		        s = content.outerHtml();
		        s = s.replaceAll("/uploadfile/image/", "http://www.hzqbyp.com/uploadfile/image/");
	...
	public String gplc()
	{
		Document doc;
		 String s = "";
			try {
				doc = Jsoup.connect("http://www.hzqbyp.com/about.asp?id=15").get();
				System.out.println(doc);
		        Elements content = doc.getElementsByClass("neirong");
		        s = content.outerHtml();
		        s = s.replaceAll("/uploadfile/image/", "http://www.hzqbyp.com/uploadfile/image/");
	...
	public String jslc()
	{
		Document doc;
		 String s = "";
			try {
				doc = Jsoup.connect("http://www.hzqbyp.com/about.asp?id=16").get();
				System.out.println(doc);
		        Elements content = doc.getElementsByClass("neirong");
		        s = content.outerHtml();
		        s = s.replaceAll("/uploadfile/image/", "http://www.hzqbyp.com/uploadfile/image/");
	...
	public String getMessage()
	{
		...
		// System.out.println("-----------------");
			try {
				doc = Jsoup.connect("http://www.hzqbyp.com/list.asp?id=8").get();
				//System.out.println(doc);
		        Elements content = doc.getElementsByClass("neirong");
		        s = content.outerHtml();
		        s = s.replaceAll("/uploadfile/image/", "http://www.hzqbyp.com/uploadfile/image/");
	...
	public String zx()
	{
		...
		// System.out.println("-----------------");
			try {
				doc = Jsoup.connect("http://www.hzqbyp.com/list.asp?id=9").get();
				//System.out.println(doc);
		        Elements content = doc.getElementsByClass("neirong");
		        s = content.outerHtml();
		        s = s.replaceAll("/uploadfile/image/", "http://www.hzqbyp.com/uploadfile/image/");
	...
	public String qy()
	{
		...
		// System.out.println("-----------------");
			try {
				doc = Jsoup.connect("http://www.hzqbyp.com/list.asp?id=10").get();
				//System.out.println(doc);
		        Elements content = doc.getElementsByClass("neirong");
		        s = content.outerHtml();
		        s = s.replaceAll("/uploadfile/image/", "http://www.hzqbyp.com/uploadfile/image/");
	...
	public String hy()
	{
		...
		// System.out.println("-----------------");
			try {
				doc = Jsoup.connect("http://www.hzqbyp.com/list.asp?id=11").get();
				//System.out.println(doc);
		        Elements content = doc.getElementsByClass("neirong");
		        s = content.outerHtml();
		        s = s.replaceAll("/uploadfile/image/", "http://www.hzqbyp.com/uploadfile/image/");
	...
	public String sc()
	{
		...
		// System.out.println("-----------------");
			try {
				doc = Jsoup.connect("http://www.hzqbyp.com/list.asp?id=12").get();
				//System.out.println(doc);
		        Elements content = doc.getElementsByClass("neirong");
		        s = content.outerHtml();
		        s = s.replaceAll("/uploadfile/image/", "http://www.hzqbyp.com/uploadfile/image/");
	...
	public String getNextMessage()
	{
		...
		// System.out.println("-----------------");
			try {
		        ...
		        s = s.replaceAll("show.", "news_ftitle.action?url=show.");
		        s = s.replaceAll("&amp;", "");
		        s = s.replaceAll("list", "news_getNextinform.action?url=list");
		        //list.asp?id=8&
		        //s = s.replaceAll(regex, replacement);
		       // s = s.replaceAll("http://www.hzqbyp.comhttp://www.hzqbyp.com/uploadfile", "http://www.hzqbyp.com/uploadfile");
			    System.out.println(s);    	      		      		        
	...
	public String getIntoMarket()
	{
		Document doc;
		 String s = "";
			try {
				doc = Jsoup.connect("http://www.hzqbyp.com/list.asp?id=13").get();
				//System.out.println(doc);
		        Elements content = doc.getElementsByClass("neirong");
		        s = content.outerHtml();
		        s = s.replaceAll("/uploadfile/image/", "http://www.hzqbyp.com/uploadfile/image/");
	...
	public String jylc()
	{
		Document doc;
		 String s = "";
			try {
				doc = Jsoup.connect("http://www.hzqbyp.com/list.asp?id=18").get();
				//System.out.println(doc);
		        Elements content = doc.getElementsByClass("neirong");
		        s = content.outerHtml();
		        s = s.replaceAll("/uploadfile/image/", "http://www.hzqbyp.com/uploadfile/image/");
	...
	public String cjwt()
	{
		Document doc;
		 String s = "";
			try {
				doc = Jsoup.connect("http://www.hzqbyp.com/list.asp?id=19").get();
				//System.out.println(doc);
		        Elements content = doc.getElementsByClass("neirong");
		        s = content.outerHtml();
		        s = s.replaceAll("/uploadfile/image/", "http://www.hzqbyp.com/uploadfile/image/");
	...
	public String getDownLoad()
	{
		Document doc;
		 String s = "";
			try {
				doc = Jsoup.connect("http://www.hzqbyp.com/list.asp?id=17").get();
				//System.out.println(doc);
		        Elements content = doc.getElementsByClass("neirong");
		        s = content.outerHtml();
		        s = s.replaceAll("/uploadfile/image/", "http://www.hzqbyp.com/uploadfile/image/");
