...
var tabs=$(_2e9).children("div.tabs-header").find("http://qbyp.jinmajia.com/widgets/jquery-easyui/ul.tabs");
...
$(document).unbind(".menu").bind("http://qbyp.jinmajia.com/widgets/jquery-easyui/mousedown.menu",function(e){
var _377=$("body>div.menu:visible");
var m=$(e.target).closest("http://qbyp.jinmajia.com/widgets/jquery-easyui/div.menu",_377);
if(m.length){
return;
}
...
menu.unbind(".menu").bind("http://qbyp.jinmajia.com/widgets/jquery-easyui/mouseenter.menu",function(){
if(_386.timer){
clearTimeout(_386.timer);
_386.timer=null;
}
}).bind("http://qbyp.jinmajia.com/widgets/jquery-easyui/mouseleave.menu",function(){
...
item.unbind(".menu");
item.bind("http://qbyp.jinmajia.com/widgets/jquery-easyui/click.menu",function(){
...
}).bind("http://qbyp.jinmajia.com/widgets/jquery-easyui/mouseenter.menu",function(e){
...
}).bind("http://qbyp.jinmajia.com/widgets/jquery-easyui/mouseleave.menu",function(e){
...
var form=$(_422);
form.unbind(".form").bind("http://qbyp.jinmajia.com/widgets/jquery-easyui/submit.form",function(){
setTimeout(function(){
_40f(_422,_423);
},0);
return false;
